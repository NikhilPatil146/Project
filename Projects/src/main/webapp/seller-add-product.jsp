          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-8 col-lg-8 pb-4">
              ...
              <div class="row">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <input  name="product_name" type="text" class="form-control" id="fname">
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="form-group">
                      <label class="text-black" for="lname">Your Product Price</label>
                      <input name="product_price" type="text" class="form-control" id="lname">
                    </div>
                  </div>
                </div>
                  <div class="col-12">
                  <label class="text-black" for="address">Product Detail</label>
                  <textarea name="product_desc" rows="6" style="width: 100%" ></textarea>
                </div>
                 <div class="row">
                 <div class="col-6">
                <div class="form-group">
                ...
                <input  type="submit" name="action" value="Add Product" class="btn btn-primary-hover-outline">
                 </div>
                 </div>
              </form>
